    ...
    <tr>
      <td style="padding: 0 24px 24px 24px;">
        ...
        <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 12px; padding: 16px; font-size: 12px; color: #334155; line-height: 1.6;">
          <p style="margin: 0 0 6px 0;"><strong>⚡ Instant Online Checkout:</strong> Pay via Subscriber Portal using Xendit (GCash, Maya, Cards, QR Ph) for immediate automated receipt posting.</p>
